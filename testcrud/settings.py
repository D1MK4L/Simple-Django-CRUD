...
SECRET_KEY = 'django-insecure-i$xp!1aa!eq2rir7r)s_y)f(j-duuj4xvxde@-&5hoj%i82bb9'
...
INSTALLED_APPS = [
    ...
    'api',
    'django_extensions',
    'corsheaders', #needed for Angular interaction  
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Add this line for angular
    'django.middleware.common.CommonMiddleware',
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:4200",  # Your Angular app's development server
    "http://127.0.0.1:4200", # Optional: alternate localhost format
]
